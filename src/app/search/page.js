...
export default async function SearchPage({ searchParams }) {
  ...
  const cards = await getCards('', page, perPage)

  return (
    <div className="flex flex-col items-center justify-center">
      <div className='absolute top-[72px] w-full'>
      <form action="" className="px-4 w-full max-w-2xl mx-auto lg:px-0 lg:max-w-4xl z-0">
        ...
        <div className="relative">
          ...
          <input type="search" id="default-search" className="w-full p-2 pl-10 text-sm text-zinc-800 border border-blue-900 rounded-lg bg-sky-50 focus:ring-stone-300 focus:border-stone-300" placeholder="Search..." />
        ...
        {cards?.length === 0 ? (
          ...
          <div className="absolute top-[120px] lg:top-[124px]">
            ...
            <div className="flex justify-center my-4">
              <PaginationControls prefix='search' page={page} />
            </div>
          </div>
        )}
      </div>
