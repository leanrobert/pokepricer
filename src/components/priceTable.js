...
const PriceTable = ({ tcgplayer, cardmarket, money }) => {
	...
	return (
		<div className='flex flex-col gap-4 py-1'>
			...
			<table  className='table-fixed w-full text-center bg-sky-50 rounded-lg'>
				<thead>
					<tr className='border-blue-900 border-b-[1px]'>
						<th className='py-1' />
						<th className='bg-sky-100 text-red-600 py-1'>Recomended (ARS)</th>
				...
				<tbody>
					<tr>
						...
						<td className='bg-sky-100 text-red-600 py-1'>ARS ${values.lowRec}</td>
						<td className='py-1'>${values.lowtc}</td>
						<td className='py-1'>€{values.lowcar}</td>
					</tr>
					<tr>
						<td className='py-1'>Mid</td>
						<td className='bg-sky-100 text-red-600 py-1'>ARS ${values.midRec}</td>
						<td className='py-1'>${values.midtc}</td>
						<td className='py-1'>€{values.midcar}</td>
					</tr>
					<tr>
						<td className='py-1'>High</td>
						<td className='bg-sky-100 text-red-600 py-1'>ARS ${values.highRec}</td>
						<td className='py-1'>${values.hightc}</td>
						<td className='py-1'>€{values.highcar}</td>
					</tr>
					<tr className='font-bold'>
						<td className='py-1'>Recomended</td>
						<td className='bg-sky-100 text-red-600 py-1'>ARS ${values.avgRec}</td>
